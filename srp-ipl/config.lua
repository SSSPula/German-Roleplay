...
config.cassidyCreek                          = false  -- -425.677, 4433.404, 27.325
...
config.dignityHeistYacht                     = false  -- -2027.946, -1036.695, 6.707587
...
-- Choose One
config.nightClubStyle1                       = true
config.nightClubStyle2                       = false
config.nightClubStyle3                       = false
-- Choose One
