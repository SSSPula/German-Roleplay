...
config_cl = {
    ...
    checkpointRadius = 30.0,            -- Radius of 3D checkpoints in meters (set to 0 to disable cylinder checkpoints)
    checkpointHeight = 5.0,            -- Height of 3D checkpoints in meters
    checkpointBlipColor = 6,            -- Color of checkpoint map blips and navigation (see SetBlipColour native reference)
...
config_sv = {
    finishTimeout = 60000,             -- Timeout in ms for removing a race after winner finishes
