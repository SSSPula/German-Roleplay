...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == "" then
		TriggerServerEvent('grp_lolxd:IchBinDas', data, myIdentifiers)
		EnableGui(false)
		Citizen.Wait(500)
		TriggerEvent('esx_skin:openSaveableMenu', myIdentifiers.id)
		--test hier
		TriggerEvent("InteractSound_CL:PlayOnOne", "spawnhalle1", 0.5)
		Citizen.Wait(12069)
		TriggerEvent("InteractSound_CL:PlayOnOne", "spawnhalle2", 0.5)
		SetEntityCoords(GetPlayerPed(-1), tonumber("-2001.66"), tonumber("3194.48"), tonumber("33.78"), 1, 0, 0, 1)
	else
