...
AddEventHandler('nk_repair:MenuRipara', function()
	...
	if DoesEntityExist(veh) then
		...
		exports['mythic_notify']:DoHudText('inform', 'Kein Defektes Fahrzeug in der Nähe!', { ['background-color'] = '#ffffff', ['color'] = '#000000' })
		end
	end
end)
