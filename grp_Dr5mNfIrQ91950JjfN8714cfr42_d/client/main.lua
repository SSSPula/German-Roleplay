...
ESX = nil
local dfffKFnbCVkYs435555dfe454GcKDjfeeeegiBB = false
local dfffKFnbCVkY4489s435555dfe454GcKDjfeeeegiBB = false
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		if dfffKFnbCVkYs435555dfe454GcKDjfeeeegiBB then
