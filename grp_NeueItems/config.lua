...
Config.orange   = 'donator2', 'donator3', 'donator4', 'donator5'
Config.aqua		= 'donator3', 'donator4', 'donator5'
Config.gold		= 'donator4', 'donator5'
Config.platin   = 'donator5'

Config.EnableHandcuffTimer        = true -- enable handcuff timer? will unrestrain player after the time ends
Config.HandcuffTimer              = 4 * 60000 -- 4 mins
