...
EnableInteriorProp(int_stock5, "meth_app")
EnableInteriorProp(int_stock5, "meth_staff_01")
--EnableInteriorProp(int_stock5, "meth_staff_02")

EnableInteriorProp(int_stock5, "meth_basic_lab_01")
--EnableInteriorProp(int_stock5, "meth_basic_lab_02")
EnableInteriorProp(int_stock5, "meth_basic_lab_01_2")
--EnableInteriorProp(int_stock5, "meth_basic_lab_02_2")

--EnableInteriorProp(int_stock5, "meth_update_lab_01")
EnableInteriorProp(int_stock5, "meth_update_lab_02")
--EnableInteriorProp(int_stock5, "meth_update_lab_01_2")
EnableInteriorProp(int_stock5, "meth_update_lab_02_2")

EnableInteriorProp(int_stock5, "meth_stock")


EnableInteriorProp(interiorHash5, "weed_app")
EnableInteriorProp(interiorHash5, "weed_staff_01")
EnableInteriorProp(interiorHash5, "weed_staff_02")

-- DisableInteriorProp(interiorHash, "weed_basic_lamp")
EnableInteriorProp(interiorHash5, "weed_update_lamp")

-- DisableInteriorProp(interiorHash, "weed_fan_basick")
EnableInteriorProp(interiorHash5, "weed_fan_update")


-- DisableInteriorProp(interiorHash5, "weed_plant_v5")
-- DisableInteriorProp(interiorHash5, "weed_plant_v6")
-- DisableInteriorProp(interiorHash5, "weed_plant_v7")
-- DisableInteriorProp(interiorHash5, "weed_plant_v8")
EnableInteriorProp(interiorHash5, "weed_plant_v8")
RefreshInterior(interiorHash5)
-- DisableInteriorProp(interiorHash, "weed_stock")

EnableInteriorProp(interiorHash3, "coke_app")
EnableInteriorProp(interiorHash3, "coke_staff_01")
EnableInteriorProp(interiorHash3, "coke_staff_02")
EnableInteriorProp(interiorHash3, "coke_stock")
RefreshInterior(interiorHash3)
EnableInteriorProp(interiorHash0, "money_app")
EnableInteriorProp(interiorHash0, "money_staff_01")
EnableInteriorProp(interiorHash0, "money_staff_02")
EnableInteriorProp(interiorHash0, "money_stock")
RefreshInterior(interiorHash0)
-- DisableInteriorProp(interiorHash, "weapon_app")
-- DisableInteriorProp(interiorHash, "weapon_staff_01")
-- DisableInteriorProp(interiorHash, "weapon_stock")
