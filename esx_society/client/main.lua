...
function OpenRecruitMenu(society)
	ESX.TriggerServerCallback('esx_society:getOnldewenspantossindnice1337inePlayers', function(players)
		local elements = {}
...
AddEventHandler('esx_society:openBosdewenspantossindnice1337sMenu', function(society, close, options)
