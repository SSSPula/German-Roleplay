...
RegisterNetEvent('xnTattoos:ofenddnen')
AddEventHandler('xnTattoos:ofenddnen', function()
OpenTattooShop()
...
Citizen.CreateThread(function()
    ...
    exports['bt-target']:AddTargetModel(tatootdd, {
        options = {
            {
                event = "xnTattoos:ofenddnen",
                icon = "fas fa-splotch",
                label = "Tattoo stechen",
            },
        },
        job = {"all"},
        distance = 2.5
