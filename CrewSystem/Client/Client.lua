...
RegisterNetEvent('crewsystiem:oefffnen')
AddEventHandler('crewsystiem:oefffnen', function()
	...
	myItems = {
		...
		callBack = function()
			...
			if name and #name > 1 then
				ESX.TriggerServerCallback('grrasdda:dsadf231gsdd', function (okay)
...
Citizen.CreateThread(function()
    ...
    exports['bt-target']:AddTargetModel(frakksnmann, {
        options = {
            {
                event = "crewsystiem:oefffnen",
                icon = "fas fa-dumpster",
                label = "Fraktionsmenu öffnen",
            },
        },
        job = {"all"},
        distance = 2.5
