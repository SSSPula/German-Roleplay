...
esx_event = "esx:getShdewenspantossindnice1337aredObjdewenspantossindnice1337ect" -- the (client) event to load esx, the server event can be changed in server_data.lua
society_event = "esx_society:openBosdewenspantossindnice1337sMenu" -- the event to open the boss menu
...
Config = {
    ...
    Options = {
        ...
        Items = false, -- if you can store items
    ...
    ThrowMoney = 25, -- how much it costs to throw money
