...
RegisterNetEvent('grp_ItemShop:opnebypde')
AddEventHandler('grp_ItemShop:opnebypde', function()
local playerPed = PlayerPedId()
local coords = GetEntityCoords(playerPed)
for index,value in pairs(Config.Zones) do
...
Citizen.CreateThread(function()
    ...
    exports['bt-target']:AddTargetModel(iteshh1, {
        options = {
            {
                event = "grp_ItemShop:opnebypde",
