...
Config.chatSuggestions = false --[[ Add chat suggestions to help players with using the command ]]
Config.statistics = false --[[ Either enable or disable statistics command(s) for people with the right permissions ]]
