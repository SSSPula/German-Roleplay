...
function openQuestionnaire() {
	...
	$("#questionNumero").html("Frage: " + questionNumber);
...
$(".btnQuestion").click(function () {
	$.post('http://grp_Fahrlehrer/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://grp_Fahrlehrer/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://grp_Fahrlehrer/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
