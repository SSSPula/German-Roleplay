...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.ibb.co/ScfxTMT/emotes.png",
-- You can change the menu position here
	MenuPosition = "right", -- (left, right)
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 311, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ...
  ['de'] = {
        ...
        ['suggestions'] = "Ein großartiges Team",
        ['suggestionsinfo'] = "'Dieses Projekt ist keine One Man Show!",
