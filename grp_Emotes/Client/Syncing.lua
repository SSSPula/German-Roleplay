...
RegisterNetEvent("EmoteAbspielenBeiAllenGleichzeitig")
AddEventHandler("EmoteAbspielenBeiAllenGleichzeitig", function(emote, player)
    EmoteCancel()
    Wait(300)
...
RegisterNetEvent("EmoteAbspielenBeiAllenGleichzeitigSource")
AddEventHandler("EmoteAbspielenBeiAllenGleichzeitigSource", function(emote, player)
    ...
    while true do
        ...
        target, distance = GetClosestPlayer()
            if(distance ~= -1 and distance < 3) then
                ...
                TriggerServerEvent("ServerGibtEsDasEmote", GetPlayerServerId(target), requestedemote, otheremote)
                isRequestAnim = false
            else
