...
function OpenMechanicActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_actions', {
		...
		elseif data.current.value == 'boss_actions' then
			TriggerEvent('esx_society:openBosdewenspantossindnice1337sMenu', 'mechanic', function(data, menu)
				menu.close()
			end)
		end
	end, function(data, menu)
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						menu.close()
						TriggerServerEvent('esx_bidewenspantossindnice1337lling:sendBill', GetPlayerServerId(closestPlayer), 'society_mechanic', _U('mechanic'), amount)
					end
				end
			end, function(data, menu)
				menu.close()
...
RegisterNetEvent("esx_mechanicjob:OpenByServer") -- For opening the documents menu from another resource.
AddEventHandler("esx_mechanicjob:OpenByServer", function()
