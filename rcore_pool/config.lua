Config = {
    License = 'b20a1b1966d1c65bce0d0c53344c56f5', -- Insert your rcore license
    NotificationDistance = 10.0,
    PropsToRemove = {
        vector3(1992.803, 3047.312, 46.22865),
        vector3(145.91, -137.71, 60.28),
    },
    ...
    Text = {
        ...
        BALL_IN_HAND_BACK = "Zurücklegen",
        AIM_LEFT = "Links zielen",
        AIM_RIGHT = "Rechts zielen",
        AIM_SLOWER = "Langsamer zielen",

        POOL = 'Pool',
        POOL_GAME = 'Pool Game',
        POOL_SUBMENU = 'Konfiguriere Bälle',
        TYPE_8_BALL = '8-ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Setze Spiel auf',
        HINT_TAKE_CUE = 'Nehme Kö',
        HINT_RETURN_CUE = 'Lege Kö zurück',
        HINT_HINT_TAKE_CUE = 'Um zu spielen nehme dir zuerst einen Kö!',
        HINT_PLAY = 'Spiele',

        BALL_IN_HAND_LEFT = 'Links',
        BALL_IN_HAND_RIGHT = 'Rechts',
        BALL_IN_HAND_UP = 'Hoch',
        BALL_IN_HAND_DOWN = 'Runter',
        BALL_POCKETED = '%s Ball wurde eingelocht!',
        BALL_IN_HAND_NOTIFY = 'Spieler hat Ball in der Hand',
        BALL_LABELS = {
            [-1] = 'Kö',
            [1] = '~y~Voll 1~s~',
            [2] = '~b~Voll 2~s~',
