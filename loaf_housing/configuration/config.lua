...
Config.AllowCircle = true -- allow to buy from circle, even though Config.REA is true.

Config.Options = {
    MenuAlign = "top-right", -- where the menus are aligned (esx_menu_default)
...
Config.IKEA = {
    EnterIKEA = vector4(62.68, -1727.83, 29.58, 228.2),
    ShellPosition = vector3(45.34, -1771.77, 29.4),
    CameraPosition = vector3(45.11, -1764.03, 34.0),
    Heading = 180.0,
    ResellPercent = 0, -- the % you get back of the original price when selling furniture
}

Config.ResellHouse = {
    ResellPercent = 0, -- the percent of money they get back from the original price
}
...
Config.Houses = {
    {
        ...
        Price = 5500000,  --minus 40% währen 5.7mio desshalb auf 5.5 "gerunded"
        Garage = {
    ...
    },
    {
        ...
        Price = 4940000, --45% Runtergesetzt
    ...
    {
        Label = "Vinewood Hills",
        Price = 5500000, -- Eigntl 5.910.000 Grenze aber 5.5
    ...
    },
    {
        ...
        Price = 5500000,  --Wie die meisten Luxus Immobilien sind -40% trotzdem über 5.5
    ...
    {
        Label = "Vinewood Hills (GOLF)",
        Price = 4000000,
        Entrance = vector4(-2588.04, 1910.93, 167.5, 185.573315620422),
        Type = "house",
        ShellType = "HighEndHouse",
    },
    {
        Label = "Vinewood Hills (custom)",
        Price = 4000000,
        Entrance = vector4(8.53, 540.24, 176.03, 159.573315620422),
        Type = "house",
        ShellType = "HighEndHouse",
    },

    {
        Label = "Das Haus des Justizministers",
        Price = 2400000,
        Entrance = vector4(-434.92, 1089.65, 332.54, 343.310),
        Type = "house",
        ShellType = "HighEndHouse",
    },
    ...
    {
        Label = "Dewens Anwalts Crip",
        Price = 2400000,
        Entrance = vector4(-468.5, 1129.09, 325.86, 256.98),
        Type = "house",
        ShellType = "HighEndHouse",
    },
