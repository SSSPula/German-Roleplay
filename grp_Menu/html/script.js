...
function closeMenu() {
    $.post('https://grp_Menu/close', JSON.stringify({}));
    ...
    if (keybind) {
      ...
      $( "div" ).each(function() {
          ...
          if (key != "-" && command != "none") {
               ...
               $.post('https://grp_Menu/registerKeybind', JSON.stringify({command: command, key: key}));
          }
    ...
    $.post('https://grp_Menu/updateKeybinds', JSON.stringify({}));
...
function clickBox(t) {
    ...
    $.post('https://grp_Menu/' + trigger, JSON.stringify({}));
