...
Text = {
	...
	['backup_requested'] = 'Verstärkung ~g~angefordert',
	['call_forwarded'] = 'Anfrage ~g~weitergeleitet',
	['someone_is_reacting'] = 'Einheit hat Dispatch ~g~BESTÄTIGT~w~ trifft bald bei Ihnen ein! Haben Sie Geduld und Vertrauen!',
...
function ToggleDuty() 
		...
		SendTextMessage("Bitte drück mich nicht :( ~b~Dewen~w~ hat das Feature noch nicht fertig.")
		SendTextMessage("~g~Schildkröten~w~ können bis zu 70 Jahre alt werden!")
end
