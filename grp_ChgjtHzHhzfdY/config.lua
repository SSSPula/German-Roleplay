...
Config.CarryViaCommand = true -- You can trigger carry via event from some menu for example TriggerEvent("grp_ChgjtHzHhzfdY:Carry") for trigger carry with certain type selected for example TriggerEvent("grp_ChgjtHzHhzfdY:Carry", "1") Types 1-3

Config.CarryCommand = "tragen" 
...
Config.RequestDuration = 30 -- in seconds
